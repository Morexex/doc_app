<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        {{-- wire:model.defer is to defer the input with the livewire propertyuntill an action is perfomed such as save button pressed  --}}
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="category" type="text" class="mt-1 block w-full" wire:model="state.category" required
